...
lin_svc = svm.LinearSVC().fit(x_train_reduced, y_train_reduced)
evaluate_classification(lin_svc, "Linear SVC(LBasedImpl)", x_train_reduced, x_test_reduced, y_train_reduced, y_test_reduced)
